...
const Sidebar = ({ isOpen = true, onToggle }) => {
  ...
  const allMenuItems = isSuperAdmin ? [...menuItems, ...superAdminItems] : menuItems;
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:sticky top-0 left-0 z-30 h-screen bg-gray-900 text-white w-64 transform transition-transform duration-300 ease-in-out ${
