  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link to="/analytics" className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Detailed sales analytics with date filters</p>
            </div>
          </div>
        </Link>

        <Link to="/analytics/users" className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
          <div className="flex items-center space-x-4">
